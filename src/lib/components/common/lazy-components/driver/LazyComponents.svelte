<script context="module">
  ...
  import ExtraBrandProductReviewsComponent from '../ExtraBrandProductReviewsComponent.svelte';
  import ExtraCartItemsComponent from '../ExtraCartItemsComponent.svelte';
  import ExtraCategoryBudgetComponent from '../ExtraCategoryBudgetComponent.svelte';
  import ExtraCategoryFeaturesComponent from '../ExtraCategoryFeaturesComponent.svelte';
